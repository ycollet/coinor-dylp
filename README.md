...
- Copy all the files from coinor-dylp to DyLP-1.10.4 (for example)
- In DyLP-1.10.4 create a build directory (mkdir build)
- In DyLP-1.10.4/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/dylp-1.10.4 -DCMAKE_BUILD_TYPE=RELEASE ..'
- In DyLP-1.10.4/build, launch 'cmake-gui .' to fine tune the configuration
...
$ tar xvfz DyLP-1.10.4.tgz
$ git clone https://github.com/ycollet/coinor-dylp.git
$ cp -r coinor-dylp/* DyLP-1.10.4/
$ cd DyLP-1.10.4
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/dylp-1.10.4 -DCMAKE_BUILD_TYPE=RELEASE ..
...
- Copy all the files from coinor-dylp to DyLP-1.10.4 (for example)
- In DyLP-1.10.4 create a build directory (mkdir build)
- In DyLP-1.10.4/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/dylp-1.10.4 -DCMAKE_BUILD_TYPE=RELEASE -G "NMake Makefiles" ..'
- In DyLP-1.10.4/build, launch 'cmake-gui .' to fine tune the configuration
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/dylp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang -DCMAKE_CXX_FLAGS="-fsanitize=memory" ..
# or
$ cmake -DCMAKE_INSTALL_PREFIX=~/dylp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang++ -DCMAKE_C_COMPILER=/usr/bin/clang \ 
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/dylp-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/opt/intel/bin/icpc -DCMAKE_C_COMPILER=/opt/intel/bin/icc ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=d:/dylp-bin -DCMAKE_BUILD_TYPE=DEBUG -G "NMake Makefiles" ..
$ nmake
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/home/me/dylp-bin -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_TOOLCHAIN_FILE=cmake/mingw64-toolchain.cmake ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/dylp-devel -DCMAKE_BUILD_TYPE=RELEASE ..
$ make
...
$ coinbrew/coinbrew fetch --git --main-proj="DyLP"
$ cp -r ../coinor-dylp/* DyLP/
$ cd DyLP
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/dylp-devel -DCMAKE_BUILD_TYPE=RELEASE ..
...
$ git clone https://github.com/coin-or/DyLP
$ cd DyLP
